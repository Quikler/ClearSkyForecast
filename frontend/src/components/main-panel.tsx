  ...
  return (
    <main className="lg:container mx-auto">
      ...
      <section className="mx-8 max-sm:mx-4 my-4"> {/* flex */}
        <Flex flexDirection='column' alignItems='center' my={4} gap={3}>
          <Text color='white' fontWeight='bold' letterSpacing={[0, 3, 5]} fontSize={fiveXlFs} textAlign='center'>Search the weather in your favorite city!</Text>
          <Flex gap={3} w='100%' maxW={800}>
            <MagnifierInput w='100%' border='1px solid indigo' className="rounded-lg overflow-hidden" />
            <button className="px-6 bg-blue-500 text-white rounded-lg">Find</button>
          </Flex>
        </Flex>
