import { Box, BoxProps, ChakraComponent, Flex, Input, useBreakpointValue } from "@chakra-ui/react";
...
export const MagnifierInput: ChakraComponent<ElementType, BoxProps> = (props) => {
  ...
  const glassSvgSize = useBreakpointValue({ base: "12px", md: "16px" });

  return (
    <Box {...props} bgColor='white' px={4} py={0}>
      <Flex justifyContent='space-between' alignItems='center' gap={2}>
        <Input h='auto' py={2} px='0' border='0' fontSize={lgFs} placeholder='Search city' focusBorderColor='transparent'></Input>
        <svg width={glassSvgSize} version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xmlSpace="preserve">
          <g>
